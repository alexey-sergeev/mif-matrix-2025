...
class mif_mr_tools_file extends mif_mr_tools_core {
    ...
    {
        if ( $template = locate_template( 'mr-tools-file.php' ) ) {
           
            load_template( $template, false );
            
        } else {
                
            load_template( dirname( __FILE__ ) . '/../templates/mr-tools-file.php', false );
    ...
    public function get_tools_file()
    {
    ...
    public function show_list_file_file()
    {
        $out = '';
