...
jQuery( document ).ready( function( jq ) {
    ...
    jq( 'body' ).on( 'click', '.catalog .category button', function() {
        ...
        // var input = jq( 'input[name=_wpnonce]' );
        // var input = jq( 'input[name="_wpnonce"]' );
        // var input = jq( 'input[name="categories[' + key + ']"]' );
        // input.attr( 'value', value );
        jq( 'input[name="categories[' + key + ']"]' ).attr( 'value', value );
        ...
        jq( this ).parent().children( 'button' ).addClass( 'btn-secondary' );
        jq( this ).parent().children( 'button' ).removeClass( 'btn-primary' );
        
        jq( this ).addClass( 'btn-primary' );
        jq( this ).removeClass( 'btn-secondary' );
    ...
    jq( 'body' ).on( 'input', '.catalog input[name=opop_search]', function() {
    ...
    function clear_box()
    {
        ...
        jq( '.catalog .card' ).parent().remove();
        jq( '.catalog .alert' ).remove();
